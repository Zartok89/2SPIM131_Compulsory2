...
void UPKProgressionSubsystem::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);
}

TStatId UPKProgressionSubsystem::GetStatId() const
{
	RETURN_QUICK_DECLARE_CYCLE_STAT(UPKProgressionSubsystem, STATGROUP_Tickables);
}
